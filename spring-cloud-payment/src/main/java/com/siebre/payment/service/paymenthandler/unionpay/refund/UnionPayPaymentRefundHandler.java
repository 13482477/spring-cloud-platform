package com.siebre.payment.service.paymenthandler.unionpay.refund;
...
public class UnionPayPaymentRefundHandler extends AbstractPaymentRefundComponent {
    ...
    protected PaymentRefundResponse handleInternal(PaymentRefundRequest paymentRefundRequest, PaymentTransaction paymentTransaction, PaymentOrder paymentOrder, PaymentWay paymentWay, PaymentInterface paymentInterface) {
        Map<String,String> requestData =  generateParamsMap(paymentRefundRequest,paymentWay,paymentTransaction);
    ...
    private Map<String,String> generateParamsMap(PaymentRefundRequest paymentRefundRequest,PaymentWay paymentWay,PaymentTransaction paymentTransaction){
        ...
        requestData.put("backUrl",paymentWay.getPaymentCallbackUrl());      //银联通用后台通知地址
