...
public class ChannelConfigController {
    ...
    @RequestMapping(value = "/api/v1/channel/alipay", method = GET)
    ...
    @RequestMapping(value = "/api/v1/channel/alipay", method = PUT)
    ...
    @RequestMapping(value = "/api/v1/channel/weChat", method = GET)
    ...
    @RequestMapping(value = "/api/v1/channel/weChat", method = PUT)
    ...
    @RequestMapping(value = "/api/v1/channel/allinpay", method = GET)
    ...
    @RequestMapping(value = "/api/v1/channel/allinpay", method = PUT)
    ...
    @RequestMapping(value = "/api/v1/channel/baofoo", method = GET)
    ...
    @RequestMapping(value = "/api/v1/channel/baofoo", method = PUT)
    ...
    @RequestMapping(value = "/api/v1/channel/uploadCert", method = POST)
    ...
    @RequestMapping(value = "/api/v1/channel/downloadCert", method = GET)
