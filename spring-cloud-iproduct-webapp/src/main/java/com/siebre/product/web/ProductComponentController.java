...
import com.siebre.product.service.InsuranceProductRepositoryWrapper;
...
final class ProductComponentController {
    ...
    @Autowired
    private InsuranceProductRepository productRepository;// TODO: 2017/7/13   不要使用该接口执行保存操作

    @Autowired
    private ProductComponentRepository productComponentRepository;

    @Autowired
    @Qualifier("productComponentRepositoryWrapperImpl")
    private InsuranceProductRepositoryWrapper repositoryWrapper;
...
//                    insuranceProductDao.save((InsuranceProduct) agreementSpec);
                    repositoryWrapper.save((InsuranceProduct) agreementSpec);
